...
export const Options = ({
    ...
    return (
      <ItemGroup className='mx-2 my-0 gap-2 flex flex-col'>
        {factor.map((i) =>
          headerState == false || (headerState == true && (currentHazard == i || currentExposure == i || currentScenario == i || currentDimension == i || currentExposureFilter == i))
            ?
            <Item variant={currentHazard == i || currentExposure == i || currentScenario == i || currentDimension == i || currentExposureFilter == i ? 'muted' : hovering == i ? "outline" : "default"}
            ...
            >
              <ItemHeader 
                className={`${currentHazard == i || currentExposure == i || currentScenario == i || currentDimension == i || currentExposureFilter == i ? 
